...
const Dashboard = () => {
  ...
  const fetchSweets = async () => {
    try {
      const response = await axios.get('https://vercel-backendsweetshopmanagement-production.up.railway.app/api/sweets');
  ...
  const filterSweets = async () => {
    try {
      ...
      if (params.toString()) {
        const response = await axios.get(`https://vercel-backendsweetshopmanagement-production.up.railway.app/api/sweets/search?${params.toString()}`);
        setFilteredSweets(response.data.sweets);
      } else {
  ...
  const handlePurchase = async (sweetId, quantity = 1) => {
    try {
      await axios.post(`https://vercel-backendsweetshopmanagement-production.up.railway.app/api/sweets/${sweetId}/purchase`, { quantity });
      fetchSweets();
  ...
  const handleRestock = async (sweetId, quantity) => {
    try {
      await axios.post(`https://vercel-backendsweetshopmanagement-production.up.railway.app/api/sweets/${sweetId}/restock`, { quantity });
      fetchSweets();
  ...
  const handleCreate = async (sweetData) => {
    try {
      await axios.post('https://vercel-backendsweetshopmanagement-production.up.railway.app/api/sweets', sweetData);
      fetchSweets();
      setShowModal(false);
  ...
  const handleUpdate = async (sweetId, sweetData) => {
    try {
      await axios.put(`https://vercel-backendsweetshopmanagement-production.up.railway.app/api/sweets/${sweetId}`, sweetData);
      fetchSweets();
      setShowModal(false);
  ...
  const handleDelete = async (sweetId) => {
    ...
    try {
      await axios.delete(`https://vercel-backendsweetshopmanagement-production.up.railway.app/api/sweets/${sweetId}`);
      fetchSweets();
